...
hl.bind("SUPER + comma", hs.dsp.workspace.swap_monitors({ monitor1 = "current", monitor2 = "+1" }))
hl.bind("SUPER + period", hs.dsp.workspace.swap_monitors({ monitor1 = "current", monitor2 = "-1" }))
